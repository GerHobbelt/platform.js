...
;(function() {
  ...
  function parse(ua) {
    ...
    var name = getName([
      ...
      'Rekonq',
      'RockMelt',
      { 'label': 'Sailfish Browser', 'pattern': 'SailfishBrowser' },
    ...
    var product = getProduct([
      ...
      { 'label': 'Galaxy A5', 'pattern': 'SM-A500|SM-A510|SM-A520' },
      { 'label': 'Galaxy A7', 'pattern': 'SM-A700|SM-A710\SM-A720' },
      ...
      { 'label': 'Galaxy S8',      'pattern': 'SM-G950' },
      { 'label': 'Galaxy S8 Edge', 'pattern': 'SM-G955' },
      { 'label': 'Galaxy S9',      'pattern': 'SM-G960' },
      { 'label': 'Galaxy S9 Edge', 'pattern': 'SM-G965' },
      { 'label': 'Galaxy J5', 'pattern': 'SM-J500' },
      { 'label': 'Galaxy J7', 'pattern': 'SM-J700' },
      'Google TV',
      'Lumia',
      'iPad',
      'iPod',
    ...
    if (!version) {
      version = getVersion([
        '(?:Cloud9|CriOS|CrMo|Edge|Edg|EdgA|EdgiOS|FxiOS|IEMobile|UCBrowser|Iron|Opera ?Mini|OPiOS|OPR|Raven|SamsungBrowser|Silk(?!/[\\d.]+$))',
        'Version',
        'HeadlessChrome',
        qualify(name),
